      ...
      <div class="col-6 d-flex flex-column justify-content-between">
        <div class="book__detail">
          ...
          <span class="book__star-rate">
            ...
            <span class="gray">${book.reviewCount} inceleme</span>
          </span>
        </div>
...
const listBasketItems = () => {
  ...
  basketListEl.innerHTML = basketListHtml
    ? basketListHtml
    : `<li class="basket__item">Sepetiniz boş.</li>`;
  ...
  if (findedBook) {
    ...
    if (basketAlreadyIndex == -1) {
      ...
      if (
        ...
        toastr.error("Stokta yeteri kadar kitaptan yok.");
        return;
      }
    }
    listBasketItems();
    toastr.success("Kitap sepetinize eklendi.");
  }
};
